...
import threading
import time
from tkinter import Tk, ttk, Label, Entry, Button, StringVar, filedialog, messagebox, OptionMenu  # Biblioteca para interface gráfica
...
#Button(janela, text="Iniciar Download", command=lambda: threading.Thread(target=download_playlist, args=(url.get())).start()).pack()
